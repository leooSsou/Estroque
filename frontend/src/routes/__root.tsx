...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Estroque — Gestão de Estoque Inteligente" },
      {
        name: "description",
        content: "Plataforma SaaS multi-loja de gestão de estoque, precificação e auditoria.",
      },
      { name: "author", content: "Estroque" },
